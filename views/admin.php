                        ...
                        <div class="col-sm-6">                      
                            ...
                            <div class="form-group" >
                                ...
                                <div class="col-sm-9" ng-class="{'has-error' : registerForm.FirstName.$invalid && !registerForm.FirstName.$pristine }" >
                                    <input type="text" class="form-control" id="FirstName" name="FirstName"  ng-model="patientData.FirstName" ng-pattern="/^[a-zA-Z ]{1,35}$/" required>
                            ...
                            <div class="form-group" >
                                ...
                                <div class="col-sm-9" ng-class="{'has-error' : registerForm.Surname.$invalid && !registerForm.Surname.$pristine }">
                                    <input type="text" class="form-control" name="Surname"  data-ng-model="patientData.Surname" ng-pattern="/^[a-zA-Z ]{1,30}$/" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9" ng-class="{'has-error' : registerForm.CellNumber.$invalid && !registerForm.CellNumber.$pristine }">
                                    <input type="text" class="form-control" name="CellNumber"  ng-model="patientData.CellNumber" required>                      
                        ...
                        <div class="col-sm-6" > 
                            <div class="form-group">
                                ...
                                <div class="col-sm-9" ng-class="{'has-error' : registerForm.Email.$invalid && !registerForm.Email.$pristine }">
                                    <input type="email" class="form-control" name="email"  ng-model="patientData.Email" ng-pattern="/^[^\s@]+@[^\s@]+\.[^\s@]{2,}$/" required>
                            ...
                            <div >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9" ng-class="{'has-error' : registerForm.kinName.$invalid && !registerForm.kinName.$pristine }">
                                        <input type="text" class="form-control" name="kinName" id="kinName" ng-model="patientData.kinName" required >    
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-sm-9" ng-class="{'has-error' : registerForm.kinCell.$invalid && !registerForm.kinCell.$pristine }">
                                        <input type="text" class="form-control" id="kinCell" name="kinCell"  ng-model="patientData.kinCell" required>                      
