...
<head>
    ...
    <body ng-controller="docReportController">
    <div class="col-md-12 header">
      <div class="logo"><h3 style="color:white;font-size:1.8em;text-align:right;">Doctor Report</h3></div> 
 </div>
...
<div class="col-md-6">
       <div id="exportable">
        <div class="col-md-8 " style="text-align: center;"> Doctor  {{detail.Firstname}} {{detail.Surname}} Summary Report</div>
            <div class= "row">
            <div class="col-md-11">               
                        ...
                        <thead >
                            ...
                            <tbody>
                                    <tr ng-repeat="appInfo in getAppInforms">                                     
                                            <td>Doctor {{detail.Firstname}} {{detail.Surname}} Treated Patient {{appInfo.Firstname}} {{appInfo.Surname}} On The Date Of {{appInfo.treatmentDate}} For {{appInfo.Description}}  At {{appInfo.Hospital_Name}}
                                           </td>            
                                    </tr>
                            </tbody>           
                    </table>                    
                ...
                <thead >
                    ...
                    <tbody>
                            <tr ng-repeat="appy in presDetails">                                     
                                    <td>Patient {{filterUsers}}  Was Treated on {{appy.treatmentDate}}  By Doctor {{appy.Firstname}} {{appy.Surname}} 
                                      At {{appy.hospital}} For {{appy.Description}}
                                   </td> 
...
<script src="js/base64.js" type="text/javascript">></script>
  <!-- Load controllers -->
<script src="angular/docReportsController.js" type="text/javascript"></script>  
