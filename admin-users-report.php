...
<div class="col-md-9">
       <div id="exportable">
        <div class="col-md-8 " style="text-align: center;"> Patients Summary Report</div>
            <div class= "row">
            <div class="col-md-10">  
                        <!-- Search bar -->
                    ...
                    <table class="table export-table table-bordered table-hover header-fixed table-striped" >
                        <thead >
                            ...
                            <tbody>
                                    <tr ng-repeat="appInfo in getAppInforms | filter:filterUsers">                                     
                                           <td>{{appInfo.FirstName}} {{appInfo.Surname}}</td>  
                                           <td>{{appInfo.HomeAddress}}</td> 
                                           <td>{{appInfo.kinName}} {{appInfo.kinCell}}</td> 
                                           <td>{{appInfo.createDate}} {{appInfo.hospital}}</td> 
                                           <td>{{appInfo.prescription}}</td>           
                                    </tr>
                            </tbody>           
                    </table>                    
                </div>
