...
app.controller("adminCentralController", function ($scope, $http, $modal, toaster,sharedService,$window) {
        ...
        var userData= $scope.sharedData[0].patientID;
         //get patients list
                $scope.patientsList=function(){
                    $http({
                        url: "central-report-doctor.php",
                        method: "GET"
                        }).then(function (results) {
                            $scope.getDoc = results.data;                  
                    });
            }
            $scope.patientsList();
            ...
            $scope.staffList=function(){
                $http({
                    url: "central-report-pham.php",
                    method: "GET"
                    }).then(function (results) {
                        $scope.getStaff = results.data;                  
                });
           }
           $scope.staffList();
